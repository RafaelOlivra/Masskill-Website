...
const useTracks = () => {
    ...
    const playTracks: Track[] = [
        ...
        },
        {
            src:
                assetsUrl +
                "/tracks/plastic-sea-masskill-demo-(Arquitetura) - C Tuning.mp3",
    ...
    const showTracks: Track[] = [
        ...
        },
        {
            src:
                assetsUrl +
                "/clicks/CHAMADA-PROX-sinusite-escape-samsara-click-vs.mp3",
...
const useSimpleLockOut = () => {
    const passwordHash = "LTQ5MzYxOTU4Ng==";
                ...
                <div className='track-list-holder'>
                    <div
                        className={
                            bootstrapStyles["row"] +
                            " " +
                            utilsStyles["align-items-center"]
                        }
                    >
                        {!isLocked && (
                            <div
                                className={
                                    bootstrapStyles["col-lg-12"] +
                                    " " +
                                    utilsStyles["text-center"]
                                }
                            >
                                <Button onClick={handleLockOut}>Acessar</Button>
                            </div>
                        )}
                        {isLocked && (
                            <>
