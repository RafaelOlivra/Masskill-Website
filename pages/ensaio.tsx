...
const useTracks = () => {
  ...
  const wcTracks: Track[] = [
    ...
    {
      src: assetsUrl + '/tracks/divine-deceiver.mp3',
    ...
    {
      src: assetsUrl + '/tracks/black-vultures-FINAL-MIX.mp3',
      name: 'Black Vultures',
      display: true,
      type: 'play-track',
      id: idCounter++,
  ...
  const wClickTracks: Track[] = [
    ...
    {
      src: assetsUrl + '/clicks/divine-deceiver-c-tuning-click.mp3',
  ...
  return { tracks: [...wcTracks, ...wClickTracks] };
};
